...
mode_t letters_to_mode(const char *letters)
{
    ...
    if (letters[2] == 'w')
        mode |= S_IWUSR;
    if (letters[3] == 'x' || letters[3] == 's')
        mode |= S_IXUSR;
    if (letters[3] == 's' || letters[3] == 'S')
        mode |= S_ISUID;
    ...
    if (letters[5] == 'w')
        mode |= S_IWGRP;
    if (letters[6] == 'x' || letters[6] == 's')
        mode |= S_IXGRP;
    if (letters[6] == 's' || letters[6] == 'S')
        mode |= S_ISGID;
    ...
    if (letters[8] == 'w')
        mode |= S_IWOTH;
    if (letters[9] == 'x' || letters[9] == 't')
        mode |= S_IXOTH;
    if (letters[9] == 't' || letters[9] == 'T')
        mode |= S_ISVTX;
